    ...
    <div className='w-full md:w-[80%] mx-auto bg-white h-[4rem] sm:h-[5rem] px-4 sm:px-8 flex flex-col justify-center rounded-lg'>
        <div className='flex items-center justify-between h-full'>
            ...
            <div className='flex items-center flex-[0.2] ml-8 space-x-6'>
                ...
                <div className='w-12 h-12 bg-rose-600 flex items-center hover:bg-rose-800 transition-all duration-150 cursor-pointer justify-center text-white rounded-full'><FaSearch /></div>
            </div>
        </div>
    </div>
  )
